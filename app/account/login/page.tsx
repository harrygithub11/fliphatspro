...
import { Eye, EyeOff, Mail, Sparkles, CheckCircle } from "lucide-react";
    ...
    const handleLogin = async (e: React.FormEvent) => {
        ...
        try {
            ...
            if (res.ok && data.success) {
                ...
                const isRootDashboard = redirectParam && redirectParam.includes("/dashboard") && !redirectParam.includes("crm.");

                if (
                    redirectParam &&
                    (redirectParam.startsWith("/") || redirectParam.includes("localhost") || redirectParam.includes("fliphats.com")) &&
                    !isRootDashboard
                ) {
            ...
            <div className="flex items-center justify-center p-8 bg-background">
                <div className="w-full max-w-[420px]">
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        {success && (
                            <div className="p-3 text-sm text-green-600 bg-green-50 dark:bg-green-950/30 border border-green-200 dark:border-green-800 rounded-lg flex items-center gap-2">
