...
const HoverButton = React.forwardRef<HTMLButtonElement, HoverButtonProps>(
    ({ className, children, ...props }, ref) => {
        ...
        const createCircle = React.useCallback((x: number, y: number) => {
            ...
            // Use CSS variables for simplified theme integration
        ...
        return (
            <button
                ...
                className={cn(
                    ...
                    "text-primary-foreground font-medium text-base leading-6",
                    "backdrop-blur-lg bg-primary",
                    "cursor-pointer overflow-hidden transition-all duration-300",
                    "before:content-[''] before:absolute before:inset-0",
                    "before:rounded-[inherit] before:pointer-events-none",
                    "before:z-[1]",
                    "before:shadow-[inset_0_0_0_1px_rgba(255,255,255,0.1),inset_0_0_16px_0_rgba(255,255,255,0.1),inset_0_-3px_12px_0_rgba(0,0,0,0.1),0_1px_3px_0_rgba(0,0,0,0.2),0_4px_12px_0_rgba(0,0,0,0.1)]",
                ...
                {...props}
                style={{
                    "--circle-start": "rgba(255, 255, 255, 0.4)",
                ...
                {circles.map(({ id, x, y, color, fadeState }) => (
                    <div
                        ...
                        className={cn(
                            ...
                            fadeState === "out" && "opacity-0 duration-[1200ms]",
                            !fadeState && "opacity-0"
                        )}
                        style={{
                            left: x,
